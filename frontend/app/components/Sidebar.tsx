          ...
          {loading ? (
            ...
            <>
              <div className='flex-1 space-y-6'>
                {macroGroups.map((group: MacroGroup) => (
                  <div key={group.id} className='space-y-2'>
                    <h3 className='px-2 text-xs font-semibold uppercase tracking-wider text-zinc-500'>{group.name}</h3>
              ...
              <div className='mt-8 pt-6 border-t border-zinc-800'>
                <h3 className='px-2 mb-2 text-xs font-semibold uppercase tracking-wider text-zinc-500'>Settings</h3>
                <ul className='space-y-1'>
                  <li>
                    <Link
                      href='/admin'
